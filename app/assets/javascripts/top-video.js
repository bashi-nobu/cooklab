$(document).on('turbolinks:load', function(){
  ...
  if (activeController == 'top' && activeAction == 'index' && windowWidth > 930) {
    ...
    var html = '<div id="top_bg_video" class="player" data-property="{videoURL:\'https://player.vimeo.com/video/316074563\',containment:\'.main__logo\',autoPlay:true, mute:true, startAt:0, opacity:1, showControls:false}"></div>';
